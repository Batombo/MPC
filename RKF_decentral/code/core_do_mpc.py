...
class model:
    ...
    def __init__(self, param_dict, *opt):
        ...
        self.name = param_dict["zone_name"]
...
class simulator:
    ...
    def __init__(self, model_simulator, param_dict, *opt):
        ...
        # DHeatrate sizes of the state vectors
...
class configuration:
    ...
    def make_step_optimizer(self):
        ...
        for i in range(U_offset.shape[0]):
			# window uppper bound is at postion 4 -> +4
            arg['ubx'][U_offset[i][0] + 4] = self.optimizer.tv_p_values[step_index][-7,i]
