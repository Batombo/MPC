...
# Create the objects for each module
model_2 = template_model.model()
# Create an optimizer object based on the template and a model
optimizer_2 = template_optimizer.optimizer(model_2)
# Create an observer object based on the template and a model
observer_2 = template_observer.observer(model_2)
# Create a simulator object based on the template and a model
simulator_2 = template_simulator.simulator(model_2)
# Create a configuration
configuration_2 = core_do_mpc.configuration(model_2, optimizer_2, observer_2, simulator_2)
# Set up the solvers
# configuration_2.setup_solver()
...
while (configuration_1.simulator.t0_sim + configuration_1.simulator.t_step_simulator < configuration_1.optimizer.t_end):
    ...
    configuration_2.make_step_optimizer()
    """
    ----------------------------
    do-mpc: Simulator
    ----------------------------
    ...
    configuration_2.make_step_observer()
    ...
    data_do_mpc.plot_animation(configuration_2)
"""
------------------------------------------------------
